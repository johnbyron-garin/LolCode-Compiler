'''
This python GUI program is used to support mac operating systems 
'''
...
root.geometry("1260x845") # sets the initial dimensions of the window to 1260 pixels width and 845 pixels height
...
lexemes_style.configure("lexemes.Treeview.Heading", font=("Arial", 14), background="black", foreground="white")
...
symbols_style.configure("Treeview.Heading", font=("Arial", 14))
...
def symbols():
    ...
    symbols_clear()  # Clear the symbols list

    content_variables = [(f'{var}', f'{variables[var]}') for var in variables]
